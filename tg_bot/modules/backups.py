...
def import_data(bot: Bot, update):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        try:
            ...
            msg.reply_text("İçe aktarmadan önce dosyayı kendiniz gibi indirmeyi ve yeniden yüklemeyi deneyin - bu görünüyor"
                           "şüpheli olmak!")
            return
        ...
        try:
            ...
            msg.reply_text("Verilerinizi geri yüklerken bir istisna oluştu. İşlem tamamlanamayabilir. Eğer "
                           "Bununla ilgili sorun yaşıyorsanız, yedekleme dosyanızla @sairbey mesajını gönderin, böylece "
                           "sorun giderilebilir. Sahibim yardımcı olmaktan mutluluk duyacaktır ve her hata "
