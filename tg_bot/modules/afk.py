...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{} Klavyeden uzakkk amınaaaahh ! ".format(update.effective_user.first_name))
    ...
    if message.entities and message.parse_entities([MessageEntity.TEXT_MENTION, MessageEntity.MENTION]):
        ...
        for ent in entities:
            ...
            if sql.is_afk(user_id):
                ...
                if not user.reason:
                    res = "{} klavyeden uzakkk amınahhh ! nedenini siktiğim :\n{} ".format(fst_name)
                else:
                    res = "{} klayeden uzakk amınahhhh ! nedenini siktiğim  :\n{}. ".format(fst_name, user.reason)
